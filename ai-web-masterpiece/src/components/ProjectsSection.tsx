...
const projects = [
  ...
  },
  {
    ...
    title: "Blog Verse",
    category: "Full Stack",
    description: "Developed a full-featured blogging platform powered by an Appwrite backend, featuring robust authentication and dynamic routing.",
  ...
  },
  {
    ...
    category: "Web App",
    description: "Created a comprehensive collection of free development tools and utilities to assist developers and designers in everyday tasks.",
  ...
  },
  {
    ...
    category: "Blockchain",
    description: "Engineered a secure crypto wallet application for seamless token swaps on the blockchain, featuring safe and verifiable transactions.",
    image: "https://images.unsplash.com/photo-1639762681485-074b7f938ba0?auto=format&fit=crop&q=80&w=800",
