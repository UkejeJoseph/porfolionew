  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center">
        ...
        >
          <h1 className="text-3xl sm:text-4xl font-light tracking-wider text-foreground flex" style={{ fontFamily: "'Sora', sans-serif" }}>
        ...
        {/* Animated word with scroll effect */}
          ...
          >
            {words.map((word) => (
              <div key={word} className="h-8 flex items-center justify-center">
                <span className="text-sm font-light tracking-[0.3em] uppercase text-muted-foreground" style={{ fontFamily: "'Inter', sans-serif" }}>
                  {word}
                </span>
              </div>
            ))}
        ...
        <div className="mt-6 flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            />
            <span className="text-xs text-muted-foreground tracking-[0.2em] uppercase" style={{ fontFamily: "'Inter', sans-serif" }}>
              Loading Experience
            </span>
          </div>
          <span className="text-lg text-foreground tabular-nums font-light" style={{ fontFamily: "'Sora', sans-serif" }}>
            {Math.round(progress)}%
          </span>
        </div>
      </div>
      ...
      <div className="absolute top-8 left-8 w-20 h-20">
        <div
          className="absolute top-0 left-0 h-px bg-gradient-to-r from-foreground/40 to-transparent"
          style={{ animation: "expandWidth 1.2s ease-out 0.2s forwards", width: 0 }}
        />
        <div
          className="absolute top-0 left-0 w-px bg-gradient-to-b from-foreground/40 to-transparent"
      ...
      <div className="absolute top-8 right-8 w-20 h-20">
        <div
          className="absolute top-0 right-0 h-px bg-gradient-to-l from-foreground/40 to-transparent"
          style={{ animation: "expandWidth 1.2s ease-out 0.3s forwards", width: 0 }}
        />
        <div
          className="absolute top-0 right-0 w-px bg-gradient-to-b from-foreground/40 to-transparent"
      ...
      <div className="absolute bottom-8 left-8 w-20 h-20">
        <div
          className="absolute bottom-0 left-0 h-px bg-gradient-to-r from-foreground/40 to-transparent"
          style={{ animation: "expandWidth 1.2s ease-out 0.4s forwards", width: 0 }}
        />
        <div
          className="absolute bottom-0 left-0 w-px bg-gradient-to-t from-foreground/40 to-transparent"
      ...
      <div className="absolute bottom-8 right-8 w-20 h-20">
        <div
          className="absolute bottom-0 right-0 h-px bg-gradient-to-l from-foreground/40 to-transparent"
          style={{ animation: "expandWidth 1.2s ease-out 0.5s forwards", width: 0 }}
        />
        <div
          className="absolute bottom-0 right-0 w-px bg-gradient-to-t from-foreground/40 to-transparent"
      ...
      <div className="absolute left-8 bottom-1/4 hidden sm:flex items-center gap-3">
        ...
        />
        <span
          className="vertical-text text-[10px] tracking-[0.4em] text-muted-foreground uppercase"
          style={{ animation: "fadeIn 1s ease-out 1s forwards", opacity: 0, fontFamily: "'Inter', sans-serif" }}
        >
          Portfolio 2026
        </span>
      </div>
      <div className="absolute right-8 top-1/4 hidden sm:flex items-center gap-3">
        <span
          className="vertical-text text-[10px] tracking-[0.4em] text-muted-foreground uppercase"
          style={{ animation: "fadeIn 1s ease-out 1.2s forwards", opacity: 0, fontFamily: "'Inter', sans-serif" }}
        >
