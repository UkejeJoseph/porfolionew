...
export default function Sidebar() {
  ...
  return (
    <div className="hidden md:block fixed w-80 bg-card border-r border-border h-screen overflow-y-auto z-40">
      <div className="p-6">
        {/* Profile Section */}
        ...
        <div className="space-y-4 mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-sm" data-testid="text-phone">8668279388</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-sm" data-testid="text-location">Nashik, India</div>
            </div>
          </div>
